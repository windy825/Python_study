...
| **3 / 19 토** |        큐 실전        | 백준 입력처리.md | 18258, 2164, 11866 |           -           |
...
|   **기 간**    |   **SWEA (본 진도)**   |          SWEA  문제          |          백준 추가 문제          |    달성 목표 OR 개념공유     |
| :------------: | :--------------------: | :--------------------------: | :------------------------------: | :--------------------------: |
| **3 / 27 일** | 그리디 (learn - AD) | 6,7,8 차시 | - | - |
| **3 / 26 토**  |   브루트포스 도전 1    |        -         |           1476, 14500            |            탐색법            |
| **3 / 24 목**  | 완전검색 (learn - AD)  |     3,4 차시     |            2309, 3085            |       브루트 포스 응용       |
| **3 / 22 화**  |        큐 도전         |        -         |         1966, 1021, 5430         |         덱 활용 권장         |
| **3 / 20 일**  |     과목평가 준비      |        -         |                -                 |              -               |
| **3 / 19 토**  |        큐 실전         |        -         |        18258, 2164, 11866        |              -               |
| **3 / 17 목**  |   Tree (learn - IM)    |    8, 9 차시     |                -                 |        트리 구조 정리        |
| **3 / 15 화** |   Tree (learn - IM)    |   6, 7 차시   |                -                 |        진도 기간 시작        |
