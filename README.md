...
| :-----------: | :-----------: | :-------------------: | :------: | :----------------------------------------------------------: | :---------------------: |
| **4 / 24 일** | **4 / 30 토** | 세그먼트 / 펜윅 트리 | - | 미 정 | 트리 심화 |
| **4 / 23 토** | **4 / 27 수** | 플로이드 | - | 미 정 | 그래프 심화 |
| **4 / 21 목** | **4 / 25 월** | 벨만 포드, 다익스트라 | - | 미 정 | 그래프 심화 |
| **4 / 19 화** | **4 / 23 토** | 위상 정렬, 크루스칼, 프림 | - | 미 정 |   알고리즘 심화 시작    |
...
|  **4/14 목**  |  **4/16 토**  |        그리디 응용        |    -     | [ 추가문제 / 그리디 응용](https://www.acmicpc.net/group/workbook/view/13776/43644) | 미뤄둔 그리디 처리 |
|  **4/12 화**  |       -       |         A형 시험          |    -     |                              -                               |        화이팅^^         |
